...
public class FormController {
    ...
    public String methode2() {
        return "Nom du methode est methode2 et tu est dans ce methode";
    }

    @Get("/identiques")
    public String mede1() {
        return "Nom du methode est methode1 et tu est dans ce methode";
    }

    @Get("/testeView")
    public ModelView transferView( String nom, @Param("mailView") String mailView, @Param("ageView") double ageView) {
